...
|---|---|---|
| 文字起こしの選択肢 | 4 プロバイダーを**実名表示**（OpenAI / Groq / ElevenLabs / Deepgram） | **2 択のみ**：高速（普通入力＝Groq whisper-large-v3-turbo・プロキシ経由）/ 正確性（ハンズフリー＝ElevenLabs scribe_v1）。※旧「高速リアルタイム」（Deepgram）は選択肢から外した |
